...
<div class="container">
    ...
    <div class="col-md-6">
        ...
        <div class="bi" back style="background-image: url(../assets/ab.jpg);background-repeat:no-repeat; background-size:cover; 
            color:black; padding-left: 2%; margin-top:-0px; margin-bottom: -30px;">

            <div class="panel-heading">
                <div class="col-md-4" style="margin-top:20px;">
                    <img src="assets/register.jpg" class="img img-responsive">
                </div>
                <p style="margin-top:20px;">Feel free to join our community and reach out your hands for the others in need. Just by registering below you can assure
                that you are ready to donate.</p>   <br>            
            </div>
