...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            <form class="form-inline" role='form' method="post" action="availability.php" style="margin-top:80px;">
                <label class="form-label">Select Blood Group: </label>
                <select name="blood_group" class="form-control">
                    <option value="Select Blood Group">-------- BG --------</option>
            ...
            <div class="form-group">
                ...
                <label>Total number of donors with <?= $donors[0]['b_type']; ?> </label><div class="emphasize"><?= count($donors); ?> Donors
                </div>
